        ...
        <div className="ms-modal-card" style={{ padding: 32, width: 440 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 8, marginBottom: 18 }}>
            {PAYMENT_METHODS.map(m => (
                ...
                >
                  <span style={{ fontSize: 12, fontWeight: 800, letterSpacing: '0.02em' }}>{m.icon}</span>
                  {m.label}
                </button>
            ))}
          </div>
      ...
      <div className="ms-modal-backdrop">
        <div className="ms-modal-card" style={{ padding: 32, width: 520 }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 20 }}>
            ...
            <button onClick={onClose} aria-label="Fechar modal" style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#9ca3af', padding: 4 }}>
          ...
          {/* Botões */}
          <div className="ms-modal-actions" style={{ display: 'flex', justifyContent: 'flex-end', gap: 10, marginTop: 24 }}>
  ...
  return (
      <div className="ms-page">
        ...
        <div className="ms-list-panel" style={{ border: '1px solid #e5e7eb', borderRadius: 12, overflow: 'hidden' }}>
          ...
          {/* Cabeçalho tabela */}
          <div className="ms-table-head" style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr 1.4fr', padding: '10px 20px', background: '#f9fafb', borderBottom: '1px solid #e5e7eb' }}>
