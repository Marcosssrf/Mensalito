            ...
            <div style={{ background: '#fff', border: '1.5px solid #e8eaed', borderRadius: 12, padding: 28 }}>
              ...
              {tenant === null ? <p style={{ color: '#a1a1aa', fontSize: 14 }}>Carregando...</p> : (
                <>
                  ...
                  <Field label="CNPJ / CPF"><input value={form.document ?? ''} onChange={e => setForm(f => ({ ...f, document: maskDocument(e.target.value) }))} placeholder="000.000.000-00 ou 00.000.000/0000-00" maxLength={18} style={inp} /></Field>
